angular.module('we_templates_pt_br').run(['$templateCache', function($templateCache) {
  'use strict';

  $templateCache.put('angularjs/admin/views/create_role_form.html',
    "create_role_form.html"
  );


  $templateCache.put('angularjs/admin/views/roles.html',
    "roles.html"
  );


  $templateCache.put('angularjs/avatar/views/change-avatar-form.html',
  ...
  $templateCache.put('angularjs/news/views/news-block.html',
  ...
  $templateCache.put('angularjs/post/views/index.html',
  ...
  $templateCache.put('angularjs/post/views/post-teaser.html',
  ...
  $templateCache.put('angularjs/post/views/post.html',
  ...
  $templateCache.put('angularjs/post/views/sharebox.html',
  ...
  $templateCache.put('angularjs/site/views/error404.html',
    "Page Not Found - Error 404"
  );


  $templateCache.put('angularjs/site/views/highlighted.html',
    "<div ng-show=\"aboutShow\"><div ng-include=\" '/angularjs/site/views/home-about-site.html' \"></div></div>"
  );


  $templateCache.put('angularjs/site/views/home-about-site.html',
  ...
  $templateCache.put('angularjs/site/views/home-logged-in.html',
    ""
  );


  $templateCache.put('angularjs/site/views/home.html',
  ...
  $templateCache.put('angularjs/site/views/sidebar.html',
  ...
  $templateCache.put('angularjs/user/views/account.html',
    "view account"
  );


  $templateCache.put('angularjs/user/views/forgotPasswordForm.html',
  ...
  $templateCache.put('angularjs/user/views/index.html',
  ...
  $templateCache.put('angularjs/user/views/login-form.html',
  ...
  $templateCache.put('angularjs/user/views/signup-form.html',
  ...
  $templateCache.put('angularjs/user/views/signup.html',
  ...
  $templateCache.put('angularjs/user/views/user-menu.html',
  ...
  $templateCache.put('angularjs/user/views/user-teaser.html',
  ...
  $templateCache.put('angularjs/user/views/user.html',
