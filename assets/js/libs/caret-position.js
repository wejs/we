...
define('caretPosition',['jquery','typeahead', 'rangy'], function () {

window.getCharacterOffsetWithin = function getCharacterOffsetWithin(range, node) {
...
window.getCaretPosition = function getCaretPosition(containerEl) {
    var range = window.getSelection().getRangeAt(0);
    return getCharacterOffsetWithin(range, containerEl)
};

window.setCaretPosition = function setCaretPosition(containerEl, index) {
